# ===========================
# File : railFenceCipherExtended.rb
#
# Credit:
...
class RailFenceCipherExtended
	...
	# deciphers with Rail Fence Cipher Extended
	...
	# saves output a file
		...
		if (_index == 0)
			begin
				...
				file.close;
				puts "\n> Rail Fence Cipher Extended enciphering result has been saved into output_encipher.txt"
			rescue
				puts "> File not found."
			end
		elsif (_index == 1)
			begin
				...
				file.print @outputText_;
				file.close;
				puts "\n> Rail Fence Cipher Extended deciphering result has been saved into output_decipher.txt"
			rescue
				puts "> File not found."
			end
		end
