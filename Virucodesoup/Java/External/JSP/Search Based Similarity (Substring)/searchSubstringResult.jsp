...
===========================
File : searchSubstringResult.jsp
...
<%
	...
	String substringFilter = request.getParameter("substring");
	...
	ResultSet resultSet = statement.executeQuery("SELECT * FROM Post WHERE title LIKE '%"+substringFilter+"%' ");
...
<html>
	<head>
		<title>Search Based Similarity/Substring</title>
	</head>
	<body>
		<% 
