/* ===========================
File : vigenereCipher_Alphabet.hpp
...
#ifndef VIGENERE_CIPHER_ALPHABET_H
#define VIGENERE_CIPHER_ALPHABET_H
...
class VigenereCipherAlphabet {
	...
	~VigenereCipherAlphabet();
	/* destroy VigenereCipherAlphabet instance */
...
#endif // VIGENERE_CIPHER_ALPHABET_H